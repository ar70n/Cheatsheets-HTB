        ...
        if (str != null) {
            ...
            if (method == null) {
                try {
                    ...
                    Log.e(TypedValues.Trigger.NAME, new StringBuilder(String.valueOf(str).length() + 34 + String.valueOf(simpleName).length() + String.valueOf(name).length()).append("Could not find method \"").append(str).append("\"on class ").append(simpleName).append(" ").append(name).toString());
                    return;
                }
            }
            try {
                ...
                Log.e(TypedValues.Trigger.NAME, new StringBuilder(String.valueOf(str2).length() + 30 + String.valueOf(simpleName2).length() + String.valueOf(name2).length()).append("Exception in call \"").append(str2).append("\"on class ").append(simpleName2).append(" ").append(name2).toString());
            }
        }
    }
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                switch (mAttrMap.get(index)) {
                    ...
                    default:
                        ...
                        Log.e(TypedValues.Trigger.NAME, new StringBuilder(String.valueOf(hexString).length() + 33).append("unused attribute 0x").append(hexString).append("   ").append(mAttrMap.get(index)).toString());
                        break;
                }
            }
        }
