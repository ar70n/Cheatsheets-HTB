                    ...
                    if (!next.startsWith("CUSTOM")) {
                        ...
                        if (!this.attributes.containsKey(str)) {
                            ...
                            if (!(viewSpline instanceof ViewSpline.CustomSet)) {
                                ...
                                Log.e("MotionPaths", new StringBuilder(String.valueOf(next).length() + 69 + String.valueOf(valueOf2).length()).append(next).append(" ViewSpline not a CustomSet frame = ").append(i).append(", value").append(valueToInterpolate).append(valueOf2).toString());
                                break;
                            } else {
