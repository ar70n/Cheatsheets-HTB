...
public class CircularFlow extends VirtualLayout {
    ...
    public void updateRadius(View view, int i) {
        if (!isUpdatable(view)) {
            Log.e(TAG, new StringBuilder(65).append("It was not possible to update radius to view with id: ").append(view.getId()).toString());
            return;
        }
    ...
    public void updateAngle(View view, float f) {
        if (!isUpdatable(view)) {
            Log.e(TAG, new StringBuilder(64).append("It was not possible to update angle to view with id: ").append(view.getId()).toString());
            return;
        }
        int indexFromId = indexFromId(view.getId());
    ...
    public void updateReference(View view, int i, float f) {
        if (!isUpdatable(view)) {
            Log.e(TAG, new StringBuilder(75).append("It was not possible to update radius and angle to view with id: ").append(view.getId()).toString());
            return;
        }
        int indexFromId = indexFromId(view.getId());
