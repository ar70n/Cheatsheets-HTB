...
public class KeyCycle extends Key {
    ...
    public void addValues(HashMap<String, ViewSpline> hashMap) {
        Debug.logStack(TypedValues.Cycle.NAME, new StringBuilder(22).append("add ").append(hashMap.size()).append(" values").toString(), 2);
        for (String next : hashMap.keySet()) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                switch (mAttrMap.get(index)) {
                    ...
                    default:
                        ...
                        Log.e(TypedValues.Cycle.NAME, new StringBuilder(String.valueOf(hexString).length() + 33).append("unused attribute 0x").append(hexString).append("   ").append(mAttrMap.get(index)).toString());
                        break;
                }
            }
        }
