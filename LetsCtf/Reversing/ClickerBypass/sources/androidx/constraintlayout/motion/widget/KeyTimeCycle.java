            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                switch (mAttrMap.get(index)) {
                    ...
                    default:
                        ...
                        Log.e("KeyTimeCycle", new StringBuilder(String.valueOf(hexString).length() + 33).append("unused attribute 0x").append(hexString).append("   ").append(mAttrMap.get(index)).toString());
                        break;
                }
            }
        }
