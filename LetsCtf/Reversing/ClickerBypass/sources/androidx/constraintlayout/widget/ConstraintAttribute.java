...
public class ConstraintAttribute {
        ...
        for (String next : hashMap.keySet()) {
            ...
            try {
                if (next.equals("BackgroundColor")) {
                    ...
                    hashMap2.put(next, new ConstraintAttribute(constraintAttribute, cls.getMethod(valueOf.length() != 0 ? "getMap".concat(valueOf) : new String("getMap"), new Class[0]).invoke(view, new Object[0])));
                }
    ...
    public static void setAttributes(View view, HashMap<String, ConstraintAttribute> hashMap) {
        ...
        for (String next : hashMap.keySet()) {
            ...
            try {
                ...
                Log.e(TAG, new StringBuilder(String.valueOf(next).length() + 34 + String.valueOf(name).length()).append(" Custom Attribute \"").append(next).append("\" not found on ").append(name).toString());
                String name2 = cls.getName();
                Log.e(TAG, new StringBuilder(String.valueOf(name2).length() + 20 + String.valueOf(str).length()).append(name2).append(" must have a method ").append(str).toString());
            } catch (IllegalAccessException e2) {
                String name3 = cls.getName();
                Log.e(TAG, new StringBuilder(String.valueOf(next).length() + 34 + String.valueOf(name3).length()).append(" Custom Attribute \"").append(next).append("\" not found on ").append(name3).toString());
                e2.printStackTrace();
            } catch (InvocationTargetException e3) {
                String name4 = cls.getName();
                Log.e(TAG, new StringBuilder(String.valueOf(next).length() + 34 + String.valueOf(name4).length()).append(" Custom Attribute \"").append(next).append("\" not found on ").append(name4).toString());
                e3.printStackTrace();
            }
        }
    }
    ...
    public void applyCustom(View view) {
        ...
        try {
            ...
            Log.e(TAG, e.getMessage());
            String name = cls.getName();
            Log.e(TAG, new StringBuilder(String.valueOf(str2).length() + 34 + String.valueOf(name).length()).append(" Custom Attribute \"").append(str2).append("\" not found on ").append(name).toString());
            String name2 = cls.getName();
            Log.e(TAG, new StringBuilder(String.valueOf(name2).length() + 20 + String.valueOf(str).length()).append(name2).append(" must have a method ").append(str).toString());
        } catch (IllegalAccessException e2) {
            String name3 = cls.getName();
            Log.e(TAG, new StringBuilder(String.valueOf(str2).length() + 34 + String.valueOf(name3).length()).append(" Custom Attribute \"").append(str2).append("\" not found on ").append(name3).toString());
            e2.printStackTrace();
        } catch (InvocationTargetException e3) {
            String name4 = cls.getName();
            Log.e(TAG, new StringBuilder(String.valueOf(str2).length() + 34 + String.valueOf(name4).length()).append(" Custom Attribute \"").append(str2).append("\" not found on ").append(name4).toString());
            e3.printStackTrace();
        }
    }
    ...
    public void setInterpolatedValue(View view, float[] fArr) {
        ...
        try {
            ...
            Log.e(TAG, new StringBuilder(String.valueOf(concat).length() + 21 + String.valueOf(name).length()).append("no method ").append(concat).append(" on View \"").append(name).append("\"").toString());
            e.printStackTrace();
        } catch (IllegalAccessException e2) {
            String name2 = Debug.getName(view);
            Log.e(TAG, new StringBuilder(String.valueOf(concat).length() + 32 + String.valueOf(name2).length()).append("cannot access method ").append(concat).append(" on View \"").append(name2).append("\"").toString());
            e2.printStackTrace();
        } catch (InvocationTargetException e3) {
            e3.printStackTrace();
        }
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            if (index == R.styleable.CustomAttribute_attributeName) {
                ...
                if (str != null && str.length() > 0) {
                    ...
                    str = new StringBuilder(String.valueOf(substring).length() + 1).append(upperCase).append(substring).toString();
                }
