...
public class ConstraintSet {
                                        ...
                                        default:
                                            switch (i2) {
                                                ...
                                                case 76:
                                                    ...
                                                    Log.w(ConstraintSet.TAG, new StringBuilder(String.valueOf(hexString).length() + 33).append("unused attribute 0x").append(hexString).append("   ").append(mapToConstant.get(index)).toString());
                                                    break;
                                                case 77:
                                                ...
                                                default:
                                                    switch (i2) {
                                                        ...
                                                        default:
                                                            ...
                                                            Log.w(ConstraintSet.TAG, new StringBuilder(String.valueOf(hexString2).length() + 34).append("Unknown attribute 0x").append(hexString2).append("   ").append(mapToConstant.get(index)).toString());
                                                            break;
                                                    }
                                            }
                                    }
    ...
    public static class Constraint {
        ...
        static class Delta {
            ...
            public void printDelta(String str) {
                Log.v(str, "int");
                for (int i = 0; i < this.mCountInt; i++) {
                    Log.v(str, new StringBuilder(25).append(this.mTypeInt[i]).append(" = ").append(this.mValueInt[i]).toString());
                }
                Log.v(str, TypedValues.Custom.S_FLOAT);
                for (int i2 = 0; i2 < this.mCountFloat; i2++) {
                    Log.v(str, new StringBuilder(29).append(this.mTypeFloat[i2]).append(" = ").append(this.mValueFloat[i2]).toString());
                }
                Log.v(str, "strings");
                for (int i3 = 0; i3 < this.mCountString; i3++) {
                    int i4 = this.mTypeString[i3];
                    String str2 = this.mValueString[i3];
                    Log.v(str, new StringBuilder(String.valueOf(str2).length() + 14).append(i4).append(" = ").append(str2).toString());
                }
                Log.v(str, TypedValues.Custom.S_BOOLEAN);
                for (int i5 = 0; i5 < this.mCountBoolean; i5++) {
                    Log.v(str, new StringBuilder(19).append(this.mTypeBoolean[i5]).append(" = ").append(this.mValueBoolean[i5]).toString());
                }
            }
        }
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (!this.mConstraints.containsKey(Integer.valueOf(id))) {
                ...
                if (this.mConstraints.containsKey(Integer.valueOf(id))) {
                    ...
                    Log.v(TAG, new StringBuilder(43).append("WARNING NO CONSTRAINTS for view ").append(id).toString());
                }
            }
        }
            ...
            switch (i2) {
                case 1:
                    if (i4 == 1) {
                        ...
                        throw new IllegalArgumentException(new StringBuilder(String.valueOf(sideToString).length() + 18).append("Left to ").append(sideToString).append(" undefined").toString());
                    }
                ...
                case 2:
                    if (i4 == 1) {
                        ...
                        throw new IllegalArgumentException(new StringBuilder(String.valueOf(sideToString2).length() + 19).append("right to ").append(sideToString2).append(" undefined").toString());
                    }
                ...
                case 3:
                    if (i4 == 3) {
                        ...
                        throw new IllegalArgumentException(new StringBuilder(String.valueOf(sideToString3).length() + 19).append("right to ").append(sideToString3).append(" undefined").toString());
                    }
                ...
                case 4:
                    if (i4 == 4) {
                        ...
                        throw new IllegalArgumentException(new StringBuilder(String.valueOf(sideToString4).length() + 19).append("right to ").append(sideToString4).append(" undefined").toString());
                    }
                ...
                case 5:
                    if (i4 == 5) {
                        ...
                        throw new IllegalArgumentException(new StringBuilder(String.valueOf(sideToString5).length() + 19).append("right to ").append(sideToString5).append(" undefined").toString());
                    }
                case 6:
                    if (i4 == 6) {
                        ...
                        throw new IllegalArgumentException(new StringBuilder(String.valueOf(sideToString6).length() + 19).append("right to ").append(sideToString6).append(" undefined").toString());
                    }
                ...
                case 7:
                    if (i4 == 7) {
                        ...
                        throw new IllegalArgumentException(new StringBuilder(String.valueOf(sideToString7).length() + 19).append("right to ").append(sideToString7).append(" undefined").toString());
                    }
                ...
                default:
                    ...
                    throw new IllegalArgumentException(new StringBuilder(String.valueOf(sideToString8).length() + 12 + String.valueOf(sideToString9).length()).append(sideToString8).append(" to ").append(sideToString9).append(" unknown").toString());
            }
        }
    }
    ...
    public void load(android.content.Context r10, org.xmlpull.v1.XmlPullParser r11) {
        /*
            r9 = this;
            int r0 = r11.getEventType()     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            r1 = 0
            r2 = r1
        L_0x0006:
            r3 = 1
            ...
            goto L_0x01d9
        L_0x0015:
            java.lang.String r0 = r11.getName()     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            java.util.Locale r8 = java.util.Locale.ROOT     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            java.lang.String r0 = r0.toLowerCase(r8)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            int r8 = r0.hashCode()     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            switch(r8) {
            ...
            }     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
        L_0x0026:
            goto L_0x004e
        L_0x0027:
            java.lang.String r8 = "constraintset"
            boolean r0 = r0.equals(r8)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            if (r0 == 0) goto L_0x004e
            r4 = r7
            goto L_0x004e
        L_0x0031:
            java.lang.String r7 = "constraintoverride"
            boolean r0 = r0.equals(r7)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            if (r0 == 0) goto L_0x004e
            r4 = r6
            goto L_0x004e
        L_0x003b:
        ...
        L_0x004e:
            ...
            goto L_0x01d9
        L_0x0058:
            java.util.HashMap<java.lang.Integer, androidx.constraintlayout.widget.ConstraintSet$Constraint> r0 = r9.mConstraints     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            int r3 = r2.mViewId     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            java.lang.Integer r3 = java.lang.Integer.valueOf(r3)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            r0.put(r3, r2)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            r2 = r1
            goto L_0x01d9
        L_0x0066:
            return
        ...
        L_0x0074:
            ...
            boolean r0 = r0.equals(r5)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
        ...
        L_0x0089:
            ...
            boolean r0 = r0.equals(r6)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            if (r0 == 0) goto L_0x00d9
            r4 = r5
            goto L_0x00d9
        L_0x0093:
        ...
        L_0x00e2:
            ...
            java.util.HashMap<java.lang.String, androidx.constraintlayout.widget.ConstraintAttribute> r0 = r2.mCustomConstraints     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            androidx.constraintlayout.widget.ConstraintAttribute.parse(r10, r11, r0)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            goto L_0x01d9
        L_0x00eb:
            java.lang.RuntimeException r10 = new java.lang.RuntimeException     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            int r11 = r11.getLineNumber()     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            r1.<init>(r5)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            java.lang.StringBuilder r0 = r1.append(r0)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            java.lang.StringBuilder r11 = r0.append(r11)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            java.lang.String r11 = r11.toString()     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            r10.<init>(r11)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            throw r10     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
        L_0x0106:
            if (r2 == 0) goto L_0x0113
            androidx.constraintlayout.widget.ConstraintSet$Motion r0 = r2.motion     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            android.util.AttributeSet r3 = android.util.Xml.asAttributeSet(r11)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            r0.fillFromAttributeList(r10, r3)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            goto L_0x01d9
        L_0x0113:
            java.lang.RuntimeException r10 = new java.lang.RuntimeException     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            int r11 = r11.getLineNumber()     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
        ...
        L_0x012e:
            ...
            androidx.constraintlayout.widget.ConstraintSet$Layout r0 = r2.layout     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            android.util.AttributeSet r3 = android.util.Xml.asAttributeSet(r11)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            r0.fillFromAttributeList(r10, r3)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            goto L_0x01d9
        L_0x013b:
        ...
        L_0x0156:
            ...
            androidx.constraintlayout.widget.ConstraintSet$Transform r0 = r2.transform     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            android.util.AttributeSet r3 = android.util.Xml.asAttributeSet(r11)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            r0.fillFromAttributeList(r10, r3)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            goto L_0x01d9
        L_0x0163:
        ...
        L_0x017e:
            ...
            androidx.constraintlayout.widget.ConstraintSet$PropertySet r0 = r2.propertySet     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            android.util.AttributeSet r3 = android.util.Xml.asAttributeSet(r11)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            r0.fillFromAttributeList(r10, r3)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            goto L_0x01d9
        L_0x018a:
            ...
            throw r10     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
        L_0x01a5:
            android.util.AttributeSet r0 = android.util.Xml.asAttributeSet(r11)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            androidx.constraintlayout.widget.ConstraintSet$Constraint r0 = r9.fillFromAttributeList(r10, r0, r7)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            androidx.constraintlayout.widget.ConstraintSet$Layout r2 = r0.layout     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            r2.mHelperType = r3     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            goto L_0x01d4
        L_0x01b2:
            android.util.AttributeSet r0 = android.util.Xml.asAttributeSet(r11)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            androidx.constraintlayout.widget.ConstraintSet$Constraint r0 = r9.fillFromAttributeList(r10, r0, r7)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            androidx.constraintlayout.widget.ConstraintSet$Layout r2 = r0.layout     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            r2.mIsGuideline = r3     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            androidx.constraintlayout.widget.ConstraintSet$Layout r2 = r0.layout     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            r2.mApply = r3     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            goto L_0x01d4
        L_0x01c3:
            android.util.AttributeSet r0 = android.util.Xml.asAttributeSet(r11)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            androidx.constraintlayout.widget.ConstraintSet$Constraint r0 = r9.fillFromAttributeList(r10, r0, r3)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            goto L_0x01d4
        L_0x01cc:
            android.util.AttributeSet r0 = android.util.Xml.asAttributeSet(r11)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            androidx.constraintlayout.widget.ConstraintSet$Constraint r0 = r9.fillFromAttributeList(r10, r0, r7)     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
        L_0x01d4:
            ...
            goto L_0x01d9
        L_0x01d6:
            r11.getName()     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
        L_0x01d9:
            int r0 = r11.next()     // Catch:{ XmlPullParserException -> 0x01e4, IOException -> 0x01df }
            goto L_0x0006
        L_0x01df:
            r10 = move-exception
            r10.printStackTrace()
    ...
    private static void populateOverride(Context context, Constraint constraint, TypedArray typedArray) {
        ...
        constraint2.mDelta = delta;
        constraint2.motion.mApply = false;
        constraint2.layout.mApply = false;
        constraint2.propertySet.mApply = false;
        constraint2.transform.mApply = false;
        for (int i = 0; i < indexCount; i++) {
            int index = typedArray2.getIndex(i);
            switch (overrideMapToConstant.get(index)) {
                case 2:
                    delta.add(2, typedArray2.getDimensionPixelSize(index, constraint2.layout.bottomMargin));
                    break;
                case 5:
                    delta.add(5, typedArray2.getString(index));
                    break;
                case 6:
                    delta.add(6, typedArray2.getDimensionPixelOffset(index, constraint2.layout.editorAbsoluteX));
                    break;
                case 7:
                    delta.add(7, typedArray2.getDimensionPixelOffset(index, constraint2.layout.editorAbsoluteY));
                    break;
                case 8:
                    if (Build.VERSION.SDK_INT < 17) {
                        break;
                    } else {
                        delta.add(8, typedArray2.getDimensionPixelSize(index, constraint2.layout.endMargin));
                        break;
                    }
                case 11:
                    delta.add(11, typedArray2.getDimensionPixelSize(index, constraint2.layout.goneBottomMargin));
                    break;
                case 12:
                    delta.add(12, typedArray2.getDimensionPixelSize(index, constraint2.layout.goneEndMargin));
                    break;
                case 13:
                    delta.add(13, typedArray2.getDimensionPixelSize(index, constraint2.layout.goneLeftMargin));
                    break;
                case 14:
                    delta.add(14, typedArray2.getDimensionPixelSize(index, constraint2.layout.goneRightMargin));
                    break;
                case 15:
                    delta.add(15, typedArray2.getDimensionPixelSize(index, constraint2.layout.goneStartMargin));
                    break;
                case 16:
                    delta.add(16, typedArray2.getDimensionPixelSize(index, constraint2.layout.goneTopMargin));
                    break;
                case 17:
                    delta.add(17, typedArray2.getDimensionPixelOffset(index, constraint2.layout.guideBegin));
                    break;
                case 18:
                    delta.add(18, typedArray2.getDimensionPixelOffset(index, constraint2.layout.guideEnd));
                    break;
                case 19:
                    delta.add(19, typedArray2.getFloat(index, constraint2.layout.guidePercent));
                    break;
                case 20:
                    delta.add(20, typedArray2.getFloat(index, constraint2.layout.horizontalBias));
                    break;
                case 21:
                    delta.add(21, typedArray2.getLayoutDimension(index, constraint2.layout.mHeight));
                    break;
                case 22:
                    delta.add(22, VISIBILITY_FLAGS[typedArray2.getInt(index, constraint2.propertySet.visibility)]);
                    break;
                case 23:
                    delta.add(23, typedArray2.getLayoutDimension(index, constraint2.layout.mWidth));
                    break;
                case 24:
                    delta.add(24, typedArray2.getDimensionPixelSize(index, constraint2.layout.leftMargin));
                    break;
                case 27:
                    delta.add(27, typedArray2.getInt(index, constraint2.layout.orientation));
                    break;
                case 28:
                    delta.add(28, typedArray2.getDimensionPixelSize(index, constraint2.layout.rightMargin));
                    break;
                case 31:
                    if (Build.VERSION.SDK_INT < 17) {
                        break;
                    } else {
                        delta.add(31, typedArray2.getDimensionPixelSize(index, constraint2.layout.startMargin));
                        break;
                    }
                case 34:
                    delta.add(34, typedArray2.getDimensionPixelSize(index, constraint2.layout.topMargin));
                    break;
                case 37:
                    delta.add(37, typedArray2.getFloat(index, constraint2.layout.verticalBias));
                    break;
                case 38:
                    constraint2.mViewId = typedArray2.getResourceId(index, constraint2.mViewId);
                    delta.add(38, constraint2.mViewId);
                    break;
                case 39:
                    delta.add(39, typedArray2.getFloat(index, constraint2.layout.horizontalWeight));
                    break;
                case 40:
                    delta.add(40, typedArray2.getFloat(index, constraint2.layout.verticalWeight));
                    break;
                case 41:
                    delta.add(41, typedArray2.getInt(index, constraint2.layout.horizontalChainStyle));
                    break;
                case 42:
                    delta.add(42, typedArray2.getInt(index, constraint2.layout.verticalChainStyle));
                    break;
                case 43:
                    delta.add(43, typedArray2.getFloat(index, constraint2.propertySet.alpha));
                    break;
                case 44:
                    if (Build.VERSION.SDK_INT < 21) {
                        break;
                        ...
                        delta.add(44, true);
                        delta.add(44, typedArray2.getDimension(index, constraint2.transform.elevation));
                        break;
                    }
                case 45:
                    delta.add(45, typedArray2.getFloat(index, constraint2.transform.rotationX));
                    break;
                case 46:
                    delta.add(46, typedArray2.getFloat(index, constraint2.transform.rotationY));
                    break;
                case 47:
                    delta.add(47, typedArray2.getFloat(index, constraint2.transform.scaleX));
                    break;
                case 48:
                    delta.add(48, typedArray2.getFloat(index, constraint2.transform.scaleY));
                    break;
                case 49:
                    delta.add(49, typedArray2.getDimension(index, constraint2.transform.transformPivotX));
                    break;
                case 50:
                    delta.add(50, typedArray2.getDimension(index, constraint2.transform.transformPivotY));
                    break;
                case 51:
                    delta.add(51, typedArray2.getDimension(index, constraint2.transform.translationX));
                    break;
                case 52:
                    delta.add(52, typedArray2.getDimension(index, constraint2.transform.translationY));
                    break;
                case 53:
                    if (Build.VERSION.SDK_INT < 21) {
                        break;
                    } else {
                        delta.add(53, typedArray2.getDimension(index, constraint2.transform.translationZ));
                        break;
                    }
                case 54:
                    delta.add(54, typedArray2.getInt(index, constraint2.layout.widthDefault));
                    break;
                case 55:
                    delta.add(55, typedArray2.getInt(index, constraint2.layout.heightDefault));
                    break;
                case 56:
                    delta.add(56, typedArray2.getDimensionPixelSize(index, constraint2.layout.widthMax));
                    break;
                case 57:
                    delta.add(57, typedArray2.getDimensionPixelSize(index, constraint2.layout.heightMax));
                    break;
                case 58:
                    delta.add(58, typedArray2.getDimensionPixelSize(index, constraint2.layout.widthMin));
                    break;
                case 59:
                    delta.add(59, typedArray2.getDimensionPixelSize(index, constraint2.layout.heightMin));
                    break;
                case 60:
                    delta.add(60, typedArray2.getFloat(index, constraint2.transform.rotation));
                    break;
                case 62:
                    delta.add(62, typedArray2.getDimensionPixelSize(index, constraint2.layout.circleRadius));
                    break;
                case 63:
                    delta.add(63, typedArray2.getFloat(index, constraint2.layout.circleAngle));
                    break;
                case 64:
                    delta.add(64, lookupID(typedArray2, index, constraint2.motion.mAnimateRelativeTo));
                    break;
                case 65:
                    if (typedArray2.peekValue(index).type != 3) {
                        delta.add(65, Easing.NAMED_EASING[typedArray2.getInteger(index, 0)]);
                        break;
                    } else {
                        delta.add(65, typedArray2.getString(index));
                        break;
                    }
                case 66:
                    delta.add(66, typedArray2.getInt(index, 0));
                    break;
                case 67:
                    delta.add(67, typedArray2.getFloat(index, constraint2.motion.mPathRotate));
                    break;
                case 68:
                    delta.add(68, typedArray2.getFloat(index, constraint2.propertySet.mProgress));
                    break;
                case 69:
                    delta.add(69, typedArray2.getFloat(index, 1.0f));
                    break;
                case 70:
                    delta.add(70, typedArray2.getFloat(index, 1.0f));
                    break;
                case 71:
                    Log.e(TAG, "CURRENTLY UNSUPPORTED");
                    break;
                case 72:
                    delta.add(72, typedArray2.getInt(index, constraint2.layout.mBarrierDirection));
                    break;
                case 73:
                    delta.add(73, typedArray2.getDimensionPixelSize(index, constraint2.layout.mBarrierMargin));
                    break;
                case 74:
                    delta.add(74, typedArray2.getString(index));
                    break;
                case 75:
                    delta.add(75, typedArray2.getBoolean(index, constraint2.layout.mBarrierAllowsGoneWidgets));
                    break;
                case 76:
                    delta.add(76, typedArray2.getInt(index, constraint2.motion.mPathMotionArc));
                    break;
                case 77:
                    delta.add(77, typedArray2.getString(index));
                    break;
                case 78:
                    delta.add(78, typedArray2.getInt(index, constraint2.propertySet.mVisibilityMode));
                    break;
                case 79:
                    delta.add(79, typedArray2.getFloat(index, constraint2.motion.mMotionStagger));
                    break;
                case 80:
                    delta.add(80, typedArray2.getBoolean(index, constraint2.layout.constrainedWidth));
                    break;
                case 81:
                    delta.add(81, typedArray2.getBoolean(index, constraint2.layout.constrainedHeight));
                    break;
                case 82:
                    delta.add(82, typedArray2.getInteger(index, constraint2.motion.mAnimateCircleAngleTo));
                    break;
                case 83:
                    delta.add(83, lookupID(typedArray2, index, constraint2.transform.transformPivotTarget));
                    break;
                case 84:
                    delta.add(84, typedArray2.getInteger(index, constraint2.motion.mQuantizeMotionSteps));
                    break;
                case 85:
                    delta.add(85, typedArray2.getFloat(index, constraint2.motion.mQuantizeMotionPhase));
                    break;
                case 86:
                    TypedValue peekValue = typedArray2.peekValue(index);
                    if (peekValue.type != 1) {
                        if (peekValue.type != 3) {
                            constraint2.motion.mQuantizeInterpolatorType = typedArray2.getInteger(index, constraint2.motion.mQuantizeInterpolatorID);
                            delta.add(88, constraint2.motion.mQuantizeInterpolatorType);
                            break;
                        } else {
                            constraint2.motion.mQuantizeInterpolatorString = typedArray2.getString(index);
                            delta.add(90, constraint2.motion.mQuantizeInterpolatorString);
                            if (constraint2.motion.mQuantizeInterpolatorString.indexOf("/") <= 0) {
                                constraint2.motion.mQuantizeInterpolatorType = -1;
                                delta.add(88, constraint2.motion.mQuantizeInterpolatorType);
                                break;
                            } else {
                                constraint2.motion.mQuantizeInterpolatorID = typedArray2.getResourceId(index, -1);
                                delta.add(89, constraint2.motion.mQuantizeInterpolatorID);
                                constraint2.motion.mQuantizeInterpolatorType = -2;
                                delta.add(88, constraint2.motion.mQuantizeInterpolatorType);
                                break;
                            }
                        }
                        ...
                        constraint2.motion.mQuantizeInterpolatorID = typedArray2.getResourceId(index, -1);
                        delta.add(89, constraint2.motion.mQuantizeInterpolatorID);
                        if (constraint2.motion.mQuantizeInterpolatorID == -1) {
                            break;
                        } else {
                            constraint2.motion.mQuantizeInterpolatorType = -2;
                            delta.add(88, constraint2.motion.mQuantizeInterpolatorType);
                ...
                case 87:
                    String hexString = Integer.toHexString(index);
                    Log.w(TAG, new StringBuilder(String.valueOf(hexString).length() + 33).append("unused attribute 0x").append(hexString).append("   ").append(mapToConstant.get(index)).toString());
                    break;
                case 93:
                    delta.add(93, typedArray2.getDimensionPixelSize(index, constraint2.layout.baselineMargin));
                    break;
                case 94:
                    delta.add(94, typedArray2.getDimensionPixelSize(index, constraint2.layout.goneBaselineMargin));
                    break;
                case 95:
                    parseDimensionConstraints(delta, typedArray2, index, 0);
                    break;
                case 96:
                    parseDimensionConstraints(delta, typedArray2, index, 1);
                    break;
                case 97:
                    delta.add(97, typedArray2.getInt(index, constraint2.layout.mWrapBehavior));
                    break;
                case 98:
                    if (!MotionLayout.IS_IN_EDIT_MODE) {
                        if (typedArray2.peekValue(index).type != 3) {
                            ...
                            constraint2.mTargetString = typedArray2.getString(index);
                            break;
                        }
                    } else {
                        constraint2.mViewId = typedArray2.getResourceId(index, constraint2.mViewId);
                        if (constraint2.mViewId != -1) {
                            break;
                        } else {
                            constraint2.mTargetString = typedArray2.getString(index);
                            break;
                ...
                default:
                    String hexString2 = Integer.toHexString(index);
                    Log.w(TAG, new StringBuilder(String.valueOf(hexString2).length() + 34).append("Unknown attribute 0x").append(hexString2).append("   ").append(mapToConstant.get(index)).toString());
                    break;
            }
        }
    }
    ...
    public void dump(MotionScene motionScene, int... iArr) {
        ...
        System.out.println(new StringBuilder(23).append(hashSet.size()).append(" constraints").toString());
    ...
    class WriteXmlEngine {
        ...
        public void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                this.writer.write(new StringBuilder(String.valueOf(name).length() + 21).append("\n       android:id=\"").append(name).append("\"").toString());
        ...
        private void writeBoolen(String str, boolean z, boolean z2) throws IOException {
            if (z != z2) {
                this.writer.write(new StringBuilder(String.valueOf(str).length() + 18).append(SPACE).append(str).append("=\"").append(z).append("dp\"").toString());
            }
        }
        ...
        private void writeEnum(String str, int i, String[] strArr, int i2) throws IOException {
            if (i != i2) {
                ...
                writer2.write(new StringBuilder(String.valueOf(str).length() + 11 + String.valueOf(str2).length()).append(SPACE).append(str).append("=\"").append(str2).append("\"").toString());
            }
        }

        private void writeDimension(String str, int i, int i2) throws IOException {
            if (i != i2) {
                this.writer.write(new StringBuilder(String.valueOf(str).length() + 24).append(SPACE).append(str).append("=\"").append(i).append("dp\"").toString());
            }
        }
        ...
        private void writeBaseDimension(String str, int i, int i2) throws IOException {
            ...
            if (i == -2) {
                this.writer.write(new StringBuilder(String.valueOf(str).length() + 23).append(SPACE).append(str).append("=\"wrap_content\"").toString());
            } else if (i == -1) {
                this.writer.write(new StringBuilder(String.valueOf(str).length() + 23).append(SPACE).append(str).append("=\"match_parent\"").toString());
            } else {
                this.writer.write(new StringBuilder(String.valueOf(str).length() + 24).append(SPACE).append(str).append("=\"").append(i).append("dp\"").toString());
            }
        }
        ...
        public String getName(int i) {
            if (this.idMap.containsKey(Integer.valueOf(i))) {
                ...
                return new StringBuilder(String.valueOf(lookup).length() + 5).append("@+id/").append(lookup).toString();
            }
        }
        ...
        public String lookup(int i) {
            if (i != -1) {
                try {
                    ...
                    return new StringBuilder(18).append(EnvironmentCompat.MEDIA_UNKNOWN).append(i2).toString();
                }
            } else {
                int i3 = this.unknownCount + 1;
                this.unknownCount = i3;
                return new StringBuilder(18).append(EnvironmentCompat.MEDIA_UNKNOWN).append(i3).toString();
            }
        }
        ...
        public void writeXmlConstraint(String str, int i) throws IOException {
            if (i != -1) {
                ...
                writer2.write(valueOf.length() != 0 ? SPACE.concat(valueOf) : new String(SPACE));
                Writer writer3 = this.writer;
                String name = getName(i);
                writer3.write(new StringBuilder(String.valueOf(name).length() + 3).append("=\"").append(name).append("\"").toString());
            }
        }
        ...
        public void writeConstraint(String str, int i, String str2, int i2, int i3) throws IOException {
            if (i != -1) {
                ...
                if (i2 != 0) {
                    this.writer.write(new StringBuilder(14).append(" , ").append(i2).toString());
                }
                this.writer.write("],\n");
            }
        }
        ...
        public void writeCircle(int i, float f, int i2) throws IOException {
            if (i != -1) {
                ...
                this.writer.write(":[");
                this.writer.write(getName(i));
                this.writer.write(new StringBuilder(17).append(", ").append(f).toString());
                this.writer.write(new StringBuilder(12).append(i2).append("]").toString());
            }
        }
        ...
        public void writeVariable(String str, int i) throws IOException {
            if (i != 0 && i != -1) {
                this.writer.write(new StringBuilder(String.valueOf(str).length() + 23).append(SPACE).append(str).append("=\"").append(i).append("\"\n").toString());
            }
        }
        ...
        public void writeVariable(String str, float f, float f2) throws IOException {
            if (f != f2) {
                ...
                String valueOf = String.valueOf(str);
                writer2.write(valueOf.length() != 0 ? SPACE.concat(valueOf) : new String(SPACE));
                this.writer.write(new StringBuilder(18).append("=\"").append(f).append("\"").toString());
            }
        }
        ...
        public void writeVariable(String str, String str2, String str3) throws IOException {
            if (str2 != null && !str2.equals(str3)) {
                ...
                String valueOf = String.valueOf(str);
                writer2.write(valueOf.length() != 0 ? SPACE.concat(valueOf) : new String(SPACE));
                this.writer.write(new StringBuilder(String.valueOf(str2).length() + 3).append("=\"").append(str2).append("\"").toString());
            }
        }
        ...
        public void writeVariable(String str, int[] iArr) throws IOException {
            if (iArr != null) {
                ...
                while (i < iArr.length) {
                    Writer writer3 = this.writer;
                    String str2 = i == 0 ? "[" : ", ";
                    String valueOf2 = String.valueOf(getName(iArr[i]));
                    writer3.write(valueOf2.length() != 0 ? str2.concat(valueOf2) : new String(str2));
                    i++;
                }
                this.writer.write("],\n");
            }
        ...
        public void writeVariable(String str, String str2) throws IOException {
            if (str2 != null) {
                ...
                writer2.write(valueOf.length() != 0 ? ", ".concat(valueOf) : new String(", "));
                this.writer.write("\n");
            }
        }
    }
    ...
    class WriteJsonEngine {
        ...
        private void writeDimension(String str, int i, int i2, float f, int i3, int i4, boolean z) throws IOException {
            if (i == 0) {
                if (i4 == -1 && i3 == -1) {
                    if (i2 == 1) {
                        this.writer.write(new StringBuilder(String.valueOf(str).length() + 24).append(SPACE).append(str).append(": '???????????',\n").toString());
                    } else if (i2 == 2) {
                        this.writer.write(new StringBuilder(String.valueOf(str).length() + 29).append(SPACE).append(str).append(": '").append(f).append("%',\n").toString());
                    }
                } else if (i2 == 0) {
                    this.writer.write(new StringBuilder(String.valueOf(str).length() + 46).append(SPACE).append(str).append(": {'spread' ,").append(i3).append(", ").append(i4).append("}\n").toString());
                } else if (i2 == 1) {
                    this.writer.write(new StringBuilder(String.valueOf(str).length() + 44).append(SPACE).append(str).append(": {'wrap' ,").append(i3).append(", ").append(i4).append("}\n").toString());
                } else if (i2 == 2) {
                    this.writer.write(new StringBuilder(String.valueOf(str).length() + 56).append(SPACE).append(str).append(": {'").append(f).append("'% ,").append(i3).append(", ").append(i4).append("}\n").toString());
                }
            } else if (i == -2) {
                this.writer.write(new StringBuilder(String.valueOf(str).length() + 16).append(SPACE).append(str).append(": 'wrap'\n").toString());
            } else if (i == -1) {
                this.writer.write(new StringBuilder(String.valueOf(str).length() + 18).append(SPACE).append(str).append(": 'parent'\n").toString());
            } else {
                this.writer.write(new StringBuilder(String.valueOf(str).length() + 22).append(SPACE).append(str).append(": ").append(i).append(",\n").toString());
            }
        }
        ...
        public String getName(int i) {
            if (this.idMap.containsKey(Integer.valueOf(i))) {
                ...
                String lookup = lookup(i);
                this.idMap.put(Integer.valueOf(i), lookup);
                return new StringBuilder(String.valueOf(lookup).length() + 2).append("'").append(lookup).append("'").toString();
            }
        }
        ...
        public void writeVariable(String str, int i) throws IOException {
            if (i != 0 && i != -1) {
                ...
                writer2.write(valueOf.length() != 0 ? SPACE.concat(valueOf) : new String(SPACE));
                this.writer.write(":");
                this.writer.write(new StringBuilder(13).append(", ").append(i).toString());
                this.writer.write("\n");
            }
        }
        ...
        public void writeVariable(String str, boolean z) throws IOException {
            if (z) {
                ...
                String valueOf = String.valueOf(str);
                writer2.write(valueOf.length() != 0 ? SPACE.concat(valueOf) : new String(SPACE));
                this.writer.write(new StringBuilder(7).append(": ").append(z).toString());
                this.writer.write(",\n");
            }
        }
        ...
        public void writeVariable(String str, String str2) throws IOException {
            if (str2 != null) {
                ...
                writer3.write(valueOf2.length() != 0 ? ", ".concat(valueOf2) : new String(", "));
                this.writer.write("\n");
            }
        }
    }
