...
public class MotionController {
    ...
    private void insertKey(MotionPaths motionPaths) {
        ...
        if (binarySearch == 0) {
            Log.e(TAG, new StringBuilder(52).append(" KeyPath position \"").append(motionPaths.position).append("\" outside of range").toString());
        }
    ...
    public void setup(int r18, int r19, float r20, long r21) {
        ...
        L_0x038c:
            ...
            java.lang.String[] r10 = androidx.constraintlayout.motion.widget.MotionPaths.names
            int[] r11 = r0.mInterpolateVariables
            r11 = r11[r9]
            r10 = r10[r11]
    ...
    public String toString() {
        ...
        return new StringBuilder(88).append(" start: x: ").append(f).append(" y: ").append(f2).append(" end: x: ").append(f3).append(" y: ").append(this.mEndMotionPath.y).toString();
    }
