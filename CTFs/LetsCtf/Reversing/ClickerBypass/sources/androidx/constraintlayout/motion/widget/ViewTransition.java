...
public class ViewTransition {
    ...
    public String toString() {
        ...
        return new StringBuilder(String.valueOf(name).length() + 16).append("ViewTransition(").append(name).append(")").toString();
    }
    ...
    ViewTransition(android.content.Context r10, org.xmlpull.v1.XmlPullParser r11) {
        /*
            ...
            r9.mContext = r10
            int r2 = r11.getEventType()     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
        L_0x002a:
            r3 = 1
            ...
            goto L_0x00f6
        L_0x0037:
            java.lang.String r2 = r11.getName()     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            boolean r2 = r4.equals(r2)     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            if (r2 == 0) goto L_0x00f6
            return
        L_0x0042:
            java.lang.String r2 = r11.getName()     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            int r7 = r2.hashCode()     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            r8 = 4
            switch(r7) {
            ...
            }     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
        L_0x004e:
            goto L_0x007f
        L_0x004f:
            java.lang.String r4 = "CustomAttribute"
            boolean r4 = r2.equals(r4)     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
        ...
        L_0x0080:
            ...
            java.lang.String r3 = TAG     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            java.lang.String r4 = androidx.constraintlayout.motion.widget.Debug.getLoc()     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            java.lang.String r5 = java.lang.String.valueOf(r4)     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            int r5 = r5.length()     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            int r5 = r5 + 13
            java.lang.String r6 = java.lang.String.valueOf(r2)     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            int r6 = r6.length()     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            int r5 = r5 + r6
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            r6.<init>(r5)     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            java.lang.StringBuilder r4 = r6.append(r4)     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            java.lang.String r5 = " unknown tag "
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            java.lang.StringBuilder r2 = r4.append(r2)     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            java.lang.String r2 = r2.toString()     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            android.util.Log.e(r3, r2)     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            java.lang.String r2 = TAG     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            int r3 = r11.getLineNumber()     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            r4 = 16
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            r5.<init>(r4)     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            java.lang.String r4 = ".xml:"
            java.lang.StringBuilder r4 = r5.append(r4)     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            java.lang.StringBuilder r3 = r4.append(r3)     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            java.lang.String r3 = r3.toString()     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            android.util.Log.e(r2, r3)     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            goto L_0x00f6
        L_0x00dc:
            androidx.constraintlayout.widget.ConstraintSet$Constraint r2 = r9.mConstraintDelta     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            java.util.HashMap<java.lang.String, androidx.constraintlayout.widget.ConstraintAttribute> r2 = r2.mCustomConstraints     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            androidx.constraintlayout.widget.ConstraintAttribute.parse(r10, r11, r2)     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            goto L_0x00f6
        L_0x00e4:
            androidx.constraintlayout.widget.ConstraintSet$Constraint r2 = androidx.constraintlayout.widget.ConstraintSet.buildDelta(r10, r11)     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            r9.mConstraintDelta = r2     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            goto L_0x00f6
        L_0x00eb:
            androidx.constraintlayout.motion.widget.KeyFrames r2 = new androidx.constraintlayout.motion.widget.KeyFrames     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            r2.<init>(r10, r11)     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            r9.mKeyFrames = r2     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            goto L_0x00f6
        L_0x00f3:
            r9.parseViewTransitionTags(r10, r11)     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
        L_0x00f6:
            int r2 = r11.next()     // Catch:{ XmlPullParserException -> 0x0101, IOException -> 0x00fc }
            goto L_0x002a
        L_0x00fc:
            r10 = move-exception
            r10.printStackTrace()
