...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    class Model {
        ...
        private void debugWidget(String str, ConstraintWidget constraintWidget) {
            ...
            if (constraintWidget.mTop.mTarget != null) {
                String str7 = constraintWidget.mTop.mTarget.mType == ConstraintAnchor.Type.TOP ? str5 : "B";
            ...
            if (constraintWidget.mLeft.mTarget != null) {
                String str9 = constraintWidget.mLeft.mTarget.mType == ConstraintAnchor.Type.LEFT ? str8 : "R";
            ...
            Log.v(MotionLayout.TAG, new StringBuilder(String.valueOf(str).length() + 6 + String.valueOf(concat).length() + String.valueOf(valueOf8).length()).append(str).append(concat).append(" ---  ").append(valueOf8).toString());
        }

        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            String name = Debug.getName((View) constraintWidgetContainer.getCompanionWidget());
            String sb = new StringBuilder(String.valueOf(str).length() + 1 + String.valueOf(name).length()).append(str).append(" ").append(name).toString();
            String valueOf = String.valueOf(constraintWidgetContainer);
            Log.v(MotionLayout.TAG, new StringBuilder(String.valueOf(sb).length() + 12 + String.valueOf(valueOf).length()).append(sb).append("  ========= ").append(valueOf).toString());
            int size = constraintWidgetContainer.getChildren().size();
            for (int i = 0; i < size; i++) {
                String sb2 = new StringBuilder(String.valueOf(sb).length() + 14).append(sb).append("[").append(i).append("] ").toString();
                ConstraintWidget constraintWidget = constraintWidgetContainer.getChildren().get(i);
                String str2 = "_";
                String str3 = constraintWidget.mTop.mTarget != null ? "T" : str2;
                ...
                if (view instanceof TextView) {
                    ...
                    name2 = new StringBuilder(String.valueOf(valueOf5).length() + 2 + String.valueOf(valueOf6).length()).append(valueOf5).append("(").append(valueOf6).append(")").toString();
                }
                String valueOf7 = String.valueOf(constraintWidget);
                Log.v(MotionLayout.TAG, new StringBuilder(String.valueOf(sb2).length() + 4 + String.valueOf(name2).length() + String.valueOf(valueOf7).length() + String.valueOf(concat).length()).append(sb2).append("  ").append(name2).append(" ").append(valueOf7).append(" ").append(concat).toString());
            }
            Log.v(MotionLayout.TAG, String.valueOf(sb).concat(" done. "));
        }
    ...
    public String toString() {
        ...
        return new StringBuilder(String.valueOf(name).length() + 47 + String.valueOf(name2).length()).append(name).append("->").append(name2).append(" (pos:").append(f).append(" Dpos/Dt:").append(this.mLastVelocity).toString();
    }
    ...
    private class DevModeDraw {
        ...
        public void draw(Canvas canvas, HashMap<View, MotionController> hashMap, int i, int i2) {
            if (hashMap != null && hashMap.size() != 0) {
                ...
                if (!MotionLayout.this.isInEditMode() && (i2 & 1) == 2) {
                    ...
                    String sb = new StringBuilder(String.valueOf(resourceName).length() + 16).append(resourceName).append(":").append(MotionLayout.this.getProgress()).toString();
                    canvas.drawText(sb, 10.0f, (float) (MotionLayout.this.getHeight() - 30), this.mTextPaint);
                    canvas.drawText(sb, 11.0f, (float) (MotionLayout.this.getHeight() - 29), this.mPaint);
                }
        ...
        private void drawPathRelativeTicks(Canvas canvas, float f, float f2) {
            ...
            String sb = new StringBuilder(15).append(((float) ((int) ((hypot2 * 100.0f) / hypot))) / 100.0f).toString();
        ...
        private void drawPathCartesianTicks(Canvas canvas, float f, float f2) {
            ...
            String sb = new StringBuilder(15).append(((float) ((int) (((double) ((min2 * 100.0f) / Math.abs(f5 - f3))) + 0.5d))) / 100.0f).toString();
            getTextBounds(sb, this.mTextPaint);
            ...
            String sb2 = new StringBuilder(15).append(((float) ((int) (((double) ((max2 * 100.0f) / Math.abs(f6 - f4))) + 0.5d))) / 100.0f).toString();
        ...
        private void drawPathScreenTicks(Canvas canvas, float f, float f2, int i, int i2) {
            Canvas canvas2 = canvas;
            String sb = new StringBuilder(15).append(((float) ((int) (((double) (((f - ((float) (i / 2))) * 100.0f) / ((float) (MotionLayout.this.getWidth() - i)))) + 0.5d))) / 100.0f).toString();
            getTextBounds(sb, this.mTextPaint);
            ...
            String sb2 = new StringBuilder(15).append(((float) ((int) (((double) (((f2 - ((float) (i2 / 2))) * 100.0f) / ((float) (MotionLayout.this.getHeight() - i2)))) + 0.5d))) / 100.0f).toString();
            getTextBounds(sb2, this.mTextPaint);
    ...
    private void debugPos() {
        for (int i = 0; i < getChildCount(); i++) {
            ...
            Log.v(TAG, new StringBuilder(String.valueOf(location).length() + 27 + String.valueOf(name).length() + String.valueOf(name2).length() + String.valueOf(name3).length()).append(" ").append(location).append(" ").append(name).append(" ").append(name2).append(" ").append(name3).append(left).append(" ").append(childAt.getTop()).toString());
        }
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.mScene != null) {
            if ((this.mDebugPath & 1) == 1 && !isInEditMode()) {
                ...
                String valueOf = String.valueOf(new StringBuilder(String.valueOf(state).length() + 24).append(f).append(" fps ").append(state).append(" -> ").toString());
                String state2 = Debug.getState(this, this.mEndState);
                int i = this.mCurrentState;
                String state3 = i == -1 ? "undefined" : Debug.getState(this, i);
                String sb = new StringBuilder(String.valueOf(valueOf).length() + 36 + String.valueOf(state2).length() + String.valueOf(state3).length()).append(valueOf).append(state2).append(" (progress: ").append(progress).append(" ) state=").append(state3).toString();
    ...
    private void checkStructure() {
        ...
        while (it.hasNext()) {
            ...
            if (sparseIntArray.get(startConstraintSetId) == endConstraintSetId) {
                Log.e(TAG, new StringBuilder(String.valueOf(name).length() + 53 + String.valueOf(name2).length()).append("CHECK: two transitions with the same start and end ").append(name).append("->").append(name2).toString());
            }
            if (sparseIntArray2.get(endConstraintSetId) == startConstraintSetId) {
                Log.e(TAG, new StringBuilder(String.valueOf(name).length() + 43 + String.valueOf(name2).length()).append("CHECK: you can't have reverse transitions").append(name).append("->").append(name2).toString());
            }
    ...
    private void checkStructure(int i, ConstraintSet constraintSet) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            if (id == -1) {
                ...
                Log.w(TAG, new StringBuilder(String.valueOf(name).length() + 45 + String.valueOf(name2).length()).append("CHECK: ").append(name).append(" ALL VIEWS SHOULD HAVE ID's ").append(name2).append(" does not!").toString());
            }
            if (constraintSet.getConstraint(id) == null) {
                String name3 = Debug.getName(childAt);
                Log.w(TAG, new StringBuilder(String.valueOf(name).length() + 27 + String.valueOf(name3).length()).append("CHECK: ").append(name).append(" NO CONSTRAINTS for ").append(name3).toString());
            }
        }
        ...
        for (int i3 = 0; i3 < knownIds.length; i3++) {
            ...
            if (findViewById(knownIds[i3]) == null) {
                Log.w(TAG, new StringBuilder(String.valueOf(name).length() + 27 + String.valueOf(name4).length()).append("CHECK: ").append(name).append(" NO View matches id ").append(name4).toString());
            }
            if (constraintSet.getHeight(i4) == -1) {
                Log.w(TAG, new StringBuilder(String.valueOf(name).length() + 26 + String.valueOf(name4).length()).append("CHECK: ").append(name).append("(").append(name4).append(") no LAYOUT_HEIGHT").toString());
            }
    ...
    public void getAnchorDpDt(int i, float f, float f2, float f3, float[] fArr) {
        ...
        if (viewById == null) {
            str = new StringBuilder(11).append(i).toString();
        } else {
